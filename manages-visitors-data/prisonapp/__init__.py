...
CORS(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:sw33t890@localhost/prisonapp'
...
def createDB():
    engine = sqlalchemy.create_engine('mysql://root:sw33t890@localhost') #connects to server
